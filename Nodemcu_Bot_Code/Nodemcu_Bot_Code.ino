...
void Set_Speed(char value)
{
  ...
  switch(value)
  {
     case '0':analogWrite(pwmPin,0);
             break;
     case '1':analogWrite(pwmPin,200);
               break;
     case '2':analogWrite(pwmPin,300);
              break;
     case '3':analogWrite(pwmPin,400);
              break;
     case '4':analogWrite(pwmPin,500);
              break;
     case '5':analogWrite(pwmPin,600);
              break;
     case '6':analogWrite(pwmPin,700);
              break;
     case '7':analogWrite(pwmPin,800);
              break;
     case '8':analogWrite(pwmPin,900);
              break;
     case '9':analogWrite(pwmPin,1023);
              break;
